...
var JSEncrypt = /** @class */ (function () {
    ...
    JSEncrypt.prototype.decryptUnicodeLong = function (str) {
        ...
        try {
            ...
            var decode = decodeURIComponent(hexString);
            var decryptedString_1 = "";
            var rexStr = ".{1," + maxLength + "}";
            var rex = new RegExp(rexStr, 'g');
            var subStrArray = decode.match(rex);
            if (subStrArray) {
                subStrArray.forEach(function (entry) {
                    decryptedString_1 += k.decrypt(entry);
                });
                return decryptedString_1;
            }
        }
        catch (ex) {
            return false;
    ...
    JSEncrypt.prototype.hexToBytes = function (hex) {
    ...
    JSEncrypt.prototype.decryptLong2 = function (strr) {
        var k = this.getKey();
     ...
     * @public
     */
    JSEncrypt.prototype.decryptLong = function (strr) {
        var k = this.getKey();
